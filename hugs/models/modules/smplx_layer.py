...
from .lbs import lbs_extra, lbs, find_dynamic_lmk_idx_and_bcoords, vertices2landmarks
...
class SMPLX(SMPLH):
    ...
    def forward(
        ...
        **kwargs
        ...
        vertices, joints, A, T, v_posed, v_shaped, shape_offsets, pose_offsets = lbs(shape_components, full_pose, self.v_template,
